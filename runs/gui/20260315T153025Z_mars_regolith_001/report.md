...
- Goal: Plan adaptive Bayesian optimization loops to maximize perchlorate_reduction_rate over search dimensions [temperature, UV_shielding, nutrient_concentration, water_activity] using expected_improvement acquisition with batch size 4 for up to 5e+23 iterations.
